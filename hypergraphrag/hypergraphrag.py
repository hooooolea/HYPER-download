...
class HyperGraphRAG:
        ...
        try:
            ...
            for c in string_or_strings:
                if isinstance(c, dict):
                    new_docs[compute_mdhash_id(c.get("content","").strip(), prefix="doc-")] = c
                else:
                    new_docs[compute_mdhash_id(str(c).strip(), prefix="doc-")] = {"content": str(c).strip()}
            ...
            for doc_key, doc in tqdm_async(
                ...
                chunks = {
                    ...
                    for dp in chunking_by_chapter(
                        ...
                        chapter_hint=doc.get("chapter_hint", ""),
                    )
                }
    ...
    async def ainsert_custom_kg(self, custom_kg: dict):
        ...
        try:
            ...
            if self.fragment_vdb is not None and all_chunks_data:
                await self.fragment_vdb.upsert(all_chunks_data)
    ...
    async def adelete_by_entity(self, entity_name: str):
        ...
        try:
            await self.concept_vdb.delete_entity(entity_name)
            await self.relations_vdb.delete_relation(entity_name)
